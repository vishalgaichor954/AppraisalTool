...
namespace AppraisalTool.App.Controllers
{
    public class MenuController : Controller
    {
        ...
        //    HttpResponseMessage response1 = client.GetAsync(client.BaseAddress + $"/Permission/GetAllPermissionsByRole?RoleId={Id}").Result;
        //    string data1 = response1.Content.ReadAsStringAsync().Result;
        //    var getAllPermissions1 = JsonConvert.DeserializeObject<ResponseVM>(data1);
        //    string check = JsonConvert.SerializeObject(getAllPermissions1.Data);

    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Branch",
                columns: new[] { "Id", "AddedBy", "AddedOn", "BranchCode", "BranchName" },
                values: new object[] { 1, null, new DateTime(2022, 10, 17, 9, 52, 19, 335, DateTimeKind.Utc).AddTicks(3779), "BR001", "Mumbai" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3dcb3ea0-80b1-4781-b5c0-4d85c41e55a6"), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, true, new DateTime(2022, 10, 17, 9, 52, 19, 335, DateTimeKind.Utc).AddTicks(3058), 245, new Guid("4ad901be-f447-46dd-bcf7-dbe401afa203") },
                    { new Guid("771cca4b-066c-4ac7-b3df-4d12837fe7e0"), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, true, new DateTime(2022, 10, 17, 9, 52, 19, 335, DateTimeKind.Utc).AddTicks(3033), 85, new Guid("d97a15fc-0d32-41c6-9ddf-62f0735c4c1c") },
                    { new Guid("7e94bc5b-71a5-4c8c-bc3b-71bb7976237e"), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, true, new DateTime(2022, 10, 17, 9, 52, 19, 335, DateTimeKind.Utc).AddTicks(2971), 400, new Guid("a441eb40-9636-4ee6-be49-a66c5ec1330b") },
                    { new Guid("86d3a045-b42d-4854-8150-d6a374948b6e"), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, true, new DateTime(2022, 10, 17, 9, 52, 19, 335, DateTimeKind.Utc).AddTicks(3005), 135, new Guid("ac3cfaf5-34fd-4e4d-bc04-ad1083ddc340") },
                    { new Guid("ba0eb0ef-b69b-46fd-b8e2-41b4178ae7cb"), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, true, new DateTime(2022, 10, 17, 9, 52, 19, 335, DateTimeKind.Utc).AddTicks(3136), 116, new Guid("7aeb2c01-fe8e-4b84-a5ba-330bdf950f5c") },
                    { new Guid("e6a2679c-79a3-4ef1-a478-6f4c91b405b6"), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, true, new DateTime(2022, 10, 17, 9, 52, 19, 335, DateTimeKind.Utc).AddTicks(3082), 142, new Guid("7aeb2c01-fe8e-4b84-a5ba-330bdf950f5c") },
                    { new Guid("f5a6a3a0-4227-4973-abb5-a63fbe725923"), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, true, new DateTime(2022, 10, 17, 9, 52, 19, 335, DateTimeKind.Utc).AddTicks(3111), 40, new Guid("f5a6a3a0-4227-4973-abb5-a63fbe725923") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "ADMINISTRATOR" },
                    { 2, "REPORTINGAUTHORITY" },
                    { 3, "REVIEWINGAUTHORITY" }
                });
